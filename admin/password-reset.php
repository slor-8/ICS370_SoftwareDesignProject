...
<body>
    <div class="bg">
			<!-- password reset content -->
				<form class="password-reset-form" action="password-reset.php" method="POST">
	...
	$sql = "SELECT * FROM systemAdmin WHERE adminID = ' ".$_SESSION['sess_accountID']."'";
	...
	$password = $row['adminPassword'];
        ...
        else 
        {
            ...
            {
                $sql = "UPDATE systemAdmin SET adminPassword='$confirmPassword' WHERE adminID = ' ".$_SESSION['sess_accountID']."'";
                $result = mysqli_query($conn, $sql) or die(mysqli_error($conn));
                ?>
                <script type="text/javascript">
